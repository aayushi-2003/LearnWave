...
const Scholarship = () => {
  return (
    <div className='section w-full h-auto flex items-center justify-center flex-col pb-10 px-6'>
        ...
        <button className='bg-primary-pink round-full py-1 md:py-2 px-6 rounded-full text-white mt-4 lg:mt-8 hover:bg-opacity-85'>
