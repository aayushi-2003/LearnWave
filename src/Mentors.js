...
const Mentors = () => {
  return (
    <div className="section flex items-center justify-center ">
        <div className="content-box  w-full md:w-[650px] lg:w-[900px] xl:w-[1200px] bg-gradient-to-b from-secondary-blue to-primary-blue md:rounded-3xl flex items-center justify-center px-[50px] md:px-[80px] lg:px-[100px] py-[20px] md:py-[50px] md:space-x-20 flex-col lg:flex-row space-y-10 lg:space-y-0">
            <div className='space-y-6 lg:space-y-10 md:w-[650px] md:px-[80px] lg:px-0 mt-10 lg:mt-0 flex items-center justify-center flex-col'>
                ...
                <div className='w-[300px] md:w-[500px] xl:w-[650px] h-[120px] md:h-[80px] lg:h-[50px] xl:h-[70px] bg-white rounded-[10px] xl:rounded-[16px] flex flex-col lg:flex-row items-center justify-center max-lg:space-y-2 space-x-2 xl:space-x-4'>
                    ...
                    <button className='bg-primary-pink px-8 lg:px-4 xl:px-8 py-1 xl:py-2 rounded-full hover:bg-opacity-85'>
                        <span className='text-[14px] md:text-base text-white text-nowrap'>View Mentors</span>
                    </button>
                </div>
            ...
            <div className='flex flex-row lg:flex-col justify-center items-center text-white space-x-4'>
                ...
                <span className='text-secondary-pink text-[14px] md:text-[18px] font-semibold'>Ex-Amazon SDE</span>
                ...
                <button className='btn text-nowrap mt-4 xl:mt-2 '>
                    <span className='text-[14px] md:text-[16px] lg:text-[18px]'>View Profile</span>
                    </button>
                </div>
            </div>
        </div>
