export const Features = () => {
  return (
    <div className="section flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 space-x-0 md:space-x-2 lg:space-x-8 xl:space-x-10 py-10 px-20 mx-2">
